...
if( class_exists('WC_Shortcode_Products') ){
    class WooLentor_WC_Shortcode_Products extends WC_Shortcode_Products {
        ...
        protected function woocommerce_product_loop_start( $layout, $echo = true ) {
            ...
            $woolentor_loop_pre = ( function_exists('woolentor_get_theme_byname') && woolentor_get_theme_byname('kadence') ) ? 'woolentor_' : '';
            $loop_start = apply_filters( "{$woolentor_loop_pre}woocommerce_product_loop_start", ob_get_clean() );
        ...
        protected function woocommerce_product_loop_end(  $layout, $echo = true ) {
            ...
            $woolentor_loop_pre = ( function_exists('woolentor_get_theme_byname') && woolentor_get_theme_byname('kadence') ) ? 'woolentor_' : '';
            $loop_end = apply_filters( "{$woolentor_loop_pre}woocommerce_product_loop_end", ob_get_clean() );
